...
uint256 hashGenesisBlock("0000051202671aa77b52013792d5a2440c0820531e3b087b44b13eeccfaa33e2");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // MCNCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "MCNCoin Signed Message:\n";
...
{
    // MCNCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetTimespan = 1 * 60 * 60; // MCNCoin: 4 hours
static const int64 nTargetSpacing = 60; // MCNCoin: 1 minute
...
unsigned int static GetNextWorkRequired_V1(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // MCNCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
{
        static const int64 BlocksTargetSpacing = 60; // MCNCoin: 1 minute
        static const unsigned int TimeDaySeconds = 24 * 60 * 60; // MCNCoin: 1 day
...
{
    // MCNCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0000051202671aa77b52013792d5a2440c0820531e3b087b44b13eeccfaa33e2");
    }
...
bool InitBlockIndex() {
    ...
    // vMerkleTree: b0019d92bc054f7418960c91e252e7d24c77719c7a30128c5f6a827c73095d2a 
		...
		const char* pszTimestamp = "MCoin 1519816813";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1519816813;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1558518;
 ...
 if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x9935c73154c88f04b612acce7cea9ec7b125e0ddd28533b7a46f99d40c9edc89"));
...
unsigned char pchMessageStart[4] = { 0xfe, 0xc3, 0xb9, 0xde }; // MCNCoin: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("MCNCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("MCNCoinMiner : ProcessBlock, block not accepted");
    }
