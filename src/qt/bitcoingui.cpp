    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("MCNCoin") + " " + tr("Wallet"));
...
void BitcoinGUI::createActions()
{
	...
	*/
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a MCNCoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About MCNCoin"), this);
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("MCNCoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MCNCoin network", "", count));
}
...
{
    QString strTitle = tr("MCNCoin"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid MCNCoin address or malformed URI parameters."),
