...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "MCNCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"220.85.13.234", "220.85.13.234"},
    {"220.85.13.235", "220.85.13.235"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. MCNCoin is probably already running."), addrBind.ToString().c_str());
        else
