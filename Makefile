#############################################################################
# Makefile for building: MCNCoin-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: ? 3 16 19:58:36 2018
# Project:  MCNCoin-qt.pro
# Template: app
# Command: c:/Qt/4.8.6/bin/qmake.exe USE_QRCODE=1 USE_UPNP=- USE_IPV6=1 -o Makefile MCNCoin-qt.pro
#############################################################################
...
Makefile: MCNCoin-qt.pro  ../Qt/4.8.6/mkspecs/default/qmake.conf ../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=- USE_IPV6=1 -o Makefile MCNCoin-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/MCoin/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/MCoin/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/MCoin/src/leveldb/libleveldb.a: FORCE
