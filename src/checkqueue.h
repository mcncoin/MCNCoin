...
private:
    ...
    // The queue of MCNCoin to be processed.
    ...
    // This includes MCNCoin that are not anymore in queue, but still in
    ...
    // The maximum number of MCNCoin to be processed in one batch
